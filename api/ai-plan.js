...
结构示例：{"tasks":[{"id":"t1","what":"写方案","quadrant":"a","why":"今天截止","how":"先列提纲","solution":"","help":"","tag":"工作","estimated":true}],"schedule":[{"time":"09:00-09:30","taskId":"t1","minutes":30}],"notes":["写方案时长为AI估算，请确认"]}。
根据用户描述提取任务、重要性和紧急性，分入a重要紧急/b重要不紧急/c紧急不重要/d不重要不紧急。任务字段均为字符串，estimated为布尔值，表示时长是否由你估算。
只安排用户提到的任务，不为了填满空白虚构任务。tag优先选用户已有标签。具体行动建议可写how，未知求助人留空。
