...
function updateTimeStatistics() {
    ...
    // 生活任务关键词列表
    const lifeKeywords = ['做饭', '吃饭', '洗澡', '打扫卫生', '打扫', '卫生', '出门购物', '购物', '买菜', '洗衣', '洗碗', '拖地', '擦桌子', '整理房间', '倒垃圾', '遛狗', '喂猫', '照顾孩子', '接孩子', '送孩子', '陪孩子', '做家务', '家务', '生活', '休息', '睡觉', '晨跑', '洗漱', '午休', '午睡', '冥想', '瑜伽', '健身', '运动', '跑步', '散步', '通勤', '上班路上', '下班路上', '早餐', '午餐', '晚餐', '做饭', '备餐', '收拾', '整理', '清洁', '护肤', '化妆', '更衣', '穿衣', '午休', '小憩'];
